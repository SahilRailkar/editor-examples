...
const NodeViewWrapper = props => {
    ...
    return (React.createElement(Tag, Object.assign({}, props, { "data-node-view-wrapper": "", onDragStart: onDragStart, style: {
            ...props.style,
            whiteSpace: 'normal',
        } })));
};
...
const NodeViewContent = props => {
    const Tag = props.as || 'div';
    return (React.createElement(Tag, Object.assign({}, props, { "data-node-view-content": "", style: {
            ...props.style,
            whiteSpace: 'pre-wrap',
        } })));
};
